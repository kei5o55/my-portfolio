...
export default function Home() {
  ...
  return (
    <main style={{ padding: 32, maxWidth: 900, margin: "0 auto" }}>
      <h1 style={{ fontSize: 32, marginBottom: 8 }}>Portfolio</h1>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 16, marginBottom: 16, opacity: 0.7 }}>
          力を入れている制作物を掲載しています。
          <br />
          GithubのReadmeには機能詳細・工夫点などを、
          <br />
          「Detail Page
          →」には制作物に対する思いや開発背景を簡単に記載していますので、ぜひ両方ご覧ください。
        </p>
        <div
          style={{
        ...
        >
          ...
          <p>
            ...
            <br />
            ※高解像度画像を掲載しているため、読み込みに時間がかかる場合があります。
          </p>
